...
int main(void)
{
  ...
  HAL_StatusTypeDef rett = HAL_I2C_Mem_Read(&hi2c1, (0b1101000 <<1) + 0, 27, 1, temp_data, 1, 100);
  if (rett == HAL_OK){
  	  printf("Writing to register 27 \n");
    }
    else{
  	  printf("Cannot Write bro!!!! \n");
    }
  /* USER CODE END 2 */
...
//	  sprintf (msg, "Ax=%.2fg ", Ax);
//	  sprintf (msg, "Ay=%.2fg ", Ay);
//	  sprintf (msg, "Az=%.2fg ", Az);
